 ...
 * fournitures de bureau" (Services Généraux & Vie au Travail / Consommables & Fournitures),
 ...
 *
 * A supply request is really just "which article, how many" : two always-relevant fields, no
 * branching needed. Same "all fields answered every time" shape as the pilot
 ...
 */
class OfficeSuppliesFormBuilder
{
    private const FORM_NAME = 'Demande de fournitures de bureau';

    private const BRANCH_KEY = 'services_generaux';

    private const CATEGORY_PATH = ['Consommables & Fournitures'];
    ...
    /**
     * @return array{article: Question, quantite: Question}|null
     */
    private function addQuestions(Form $form): ?array
    {
        ...
        $article->add([
            ...
            'name' => __('Article souhaité', 'configurationglpiauto'),
        ...
        return ['article' => $article, 'quantite' => $quantite];
    }

    /**
     * @param array{article: Question, quantite: Question} $questions
     */
