 ...
 * catalog per explicit maintainer request : "Signaler un problème de propreté ou demander un
 * nettoyage" (Bâtiment & Moyens Généraux / Prestations & Hygiène / Propreté & Nettoyage), replacing
 ...
 *
 * Two questions, no conditional branch : where, and whether this is a cleaning to schedule ahead of
 * time or a cleanliness issue to report now — a distinction that matters for how it gets routed and
 * prioritized, but doesn't need different follow-up fields either way. Every smart form in this
...
class CleanlinessRequestFormBuilder
{
    ...
    private const TYPE_OPTIONS = [
        '1' => 'Nettoyage ponctuel à programmer',
        '2' => "Signalement d'un problème de propreté",
    ];
    ...
    /**
     * @return array{localisation: Question, type: Question}|null
     */
    private function addQuestions(Form $form): ?array
    {
        ...
        return ['localisation' => $localisation, 'type' => $type];
    }

    /**
     * @param array{localisation: Question, type: Question} $questions
     */
