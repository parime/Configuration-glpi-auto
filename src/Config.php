...
class Config extends CommonDBTM
{
    ...
    public static function getDefaults(): array
    {
        return [
            ...
            'general_ui_enabled' => 1,
            'notifications_enabled' => 1,
            'financial_info_enabled' => 1,
            ...
            'task_categories_enabled' => 1,
            'task_templates_enabled' => 1,
            'task_template_icons_enabled' => 1,
            'solution_library_enabled' => 1,
            'solution_type_icons_enabled' => 1,
            'solution_template_icons_enabled' => 1,
            'followup_library_enabled' => 1,
            'followup_library_icons_enabled' => 1,
            'validation_templates_enabled' => 1,
            'validation_template_icons_enabled' => 1,
            'change_problem_templates_enabled' => 1,
            'change_problem_template_icons_enabled' => 1,
            'locations_enabled' => 1,
            'manufacturers_enabled' => 1,
            'manufacturer_icons_enabled' => 1,
            'manufacturer_dictionary_enabled' => 1,
            'kb_categories_enabled' => 1,
            'document_management_enabled' => 1,
            'document_management_icons_enabled' => 1,
            'planning_events_enabled' => 1,
            'planning_events_icons_enabled' => 1,
            'project_taxonomy_enabled' => 1,
            'project_taxonomy_icons_enabled' => 1,
            'project_task_templates_enabled' => 1,
            'project_task_template_icons_enabled' => 1,
            ...
            'project_templates_enabled' => 1,
            'request_type_translations_enabled' => 1,
            'request_type_icons_enabled' => 1,
            'entity_native_address_enabled' => 1,
            'user_categories_enabled' => 1,
            'user_category_icons_enabled' => 1,
            'field_unicity_enabled' => 1,
            'rss_feeds_enabled' => 1,
            ...
            'certificate_types_enabled' => 1,
            'certificate_type_icons_enabled' => 1,
