 ...
 * maintainer request : "Déclarer une non-conformité" (Qualité, QHSE & Conformité / Non-conformités &
 * Actions), replacing the plain Title+Description entry that used to live in
 * `ServiceCatalogBuilder::SERVICES`.
 *
 * No conditional question : knowing which kind of non-conformity is being raised and which domain
 * or service it concerns are both always relevant together, same "all fields answered every time"
...
class NonConformityFormBuilder
{
    ...
    private const CATEGORY_PATH = ['Non-conformités & Actions'];
    ...
    private const TYPE_OPTIONS = [
        '1' => 'Non-conformité produit',
        '2' => 'Non-conformité process',
        '3' => 'Non-conformité fournisseur',
        '4' => 'Autre',
    ];
    ...
    /**
     * @return array{type: Question, domaine: Question}|null
     */
    private function addQuestions(Form $form): ?array
    {
        ...
        $type->add([
            ...
            'name' => __('Type de non-conformité', 'configurationglpiauto'),
        ...
        $domaine = new Question();
        $domaine->add([
            'forms_sections_id' => $sectionId,
            'name' => __('Domaine ou service concerné', 'configurationglpiauto'),
        ...
        return ['type' => $type, 'domaine' => $domaine];
    }

    /**
     * @param array{type: Question, domaine: Question} $questions
     */
